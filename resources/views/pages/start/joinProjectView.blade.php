                    ...
                    <div class="form-wizard">
                            <div class="form-wizard-header">
                                <ul class="list-unstyled form-wizard-steps clearfix">
                                    ...
                                    <li class="active"><span>2</span> Einladungscode</li>
                            ...
                            <fieldset class="wizard-fieldset show">
                                <div class="wizard-inner-block">
                                    <div class="verify-block">
                                        <img src="/assets/images/other//verify-ic.svg" alt="">

                                        <h3>Einladungscode</h3>
                                        <p>Gebe den Einladungscode ein den du erhalten hast</p>

                                        <div class="opt-box">
                                            <div class="verification-code">
                                                <input name="digit1" type="text" maxlength="1" class="form-control" />
                                                <input name="digit2" type="text" maxlength="1" class="form-control" />
                                                <input name="digit3" type="text" maxlength="1" class="form-control" />
                                                <input name="digit4" type="text" maxlength="1" class="form-control" />
                                            </div>
                                        </div>
