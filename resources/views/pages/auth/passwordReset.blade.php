...
<body>
    <form action="/passwords/resetDone/{{request()->route()->resetToken}}" class="kt-form" method="POST">@csrf
        ...
        <div class="right-bx">
            <div class="reigter-form">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <div class="form-floating mb-3">
                          <input type="password" class="form-control" name="password_confirmation" placeholder="placeholder" required>
                          <label for="email2">Neues Passwort bestätigen</label>
                        </div>
                    </div>
                    <button type="submit" class="btn-main">Passwort zurücksetzen</button>
                    <h6>Wieder eingefallen? <a href="/">&nbsp zum Login</a></h6>
                </form>
            </div>
        </div>
    </section>
