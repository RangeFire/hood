...
<style>
    ...
    <script>
        ...
        function changeRuntime(runtimeMonths) {
            ...
            if(runtime == 1) {                
                $('#priceSpan').html(prices.oneMonth);
                $('#runtimeDue').html(Date.today().add(1).months().toString("dd.MM.yyyy"));

                $('#productType').val("oneMonth");
                $('#productName').val("Hood One - 1 Monat");
                $('#selectRuntime').val(1);
            } else if (runtime == 3) {
                console.log("Hier Drei");
                $('#priceSpan').html((prices.oneThreeMonths*3));
    ...
    <div class="row" style="margin: 50px;">
                ...
                <div class="checkout">
                    ...
                    <div class="row mt-4">
                        <div class="col-xl-4 mr-3">
                            <img class="productLogo" src="/assets/images/productLogos/HoodOne.png">
                        </div>
                        <div class="col-xl-6">
                            <a class="productSlogan">Hood <br>All in One</a>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5 checkoutElement">
                        ...
                        <div class="col-xl-7 checkoutRightSite">
                            <div class="chooseRuntime">
                                ...
                                <input type="text" value="oneThreeMonths" id="productType" name="productType" hidden/> <!-- used to config price in service -->
                                <input type="text" value="Hood One - 3 Monate" id="productName" name="productName" hidden/> <!-- shown in the payment window and mollie -->
                                <input type="text" value="one" name="subscriptionName" hidden/> <!-- Identifier to activate right subscription in db-->
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-6 featureImage" style="background-image: url(/assets/images/background/OneCheckoutFeatures.png)"></div>
    </div>
