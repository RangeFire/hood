...
<style>
    ...
    <script>
        ...
        function changeRuntime(runtimeMonths) {
            ...
            if(runtime == 1) {
                $('#priceSpan').html(prices.monitoringProMonth);
                $('#runtimeDue').html(Date.today().add(1).months().toString("dd.MM.yyyy"));

                $('#productType').val("monitoringMonth");
                $('#productName').val("Hood Monitoring Pro - 1 Monat");
                $('#selectRuntime').val(1);
            } else if (runtime == 3) {
                $('#priceSpan').html((prices.monitoringProThreeMonths*3)-1);
                ...
                <div class="checkout">
                    ...
                    <div class="row mt-4">
                        <div class="col-xl-4 mr-3">
                            <img class="productLogo" src="/assets/images/productLogos/Monitoring.png">
                        </div>
                        <div class="col-xl-6">
                            <a class="productSlogan">Weniger Sorgen <br>Mehr Uptime</a>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5 checkoutElement">
                        ...
                        <div class="col-xl-7 checkoutRightSite">
                            <div class="chooseRuntime">
                                ...
                                <input type="text" value="monitoringProThreeMonths" id="productType" name="productType" hidden/> <!-- used to config price in service -->
                                <input type="text" value="Hood Monitoring Pro - 3 Monate" id="productName" name="productName" hidden/> <!-- shown in the payment window and mollie -->
                                <input type="text" value="monitoring" name="subscriptionName" hidden/> <!-- Identifier to activate right subscription in db-->
                            </div>
                        </div>
                    </div>
